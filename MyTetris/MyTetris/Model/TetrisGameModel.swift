...
//  MyTetris
//
//  Created by Student on 2023-04-11.
//
...
class TetrisGameModel: ObservableObject {
    ...
    func runEngine(timer: Timer){
        ...
        guard tetromino != nil else{
            print("Spawning new tetro")
            tetromino = Tetromino.createNewTetromino(numsRows: numRows, numColumns: numColumns)
...
struct Tetromino {
    ...
    static func createNewTetromino(numsRows: Int, numColumns: Int) -> Tetromino {
        ...
        let origin = BlockLocation(row: numsRows - 1 - maxRow, column: (numColumns-1)/2)
